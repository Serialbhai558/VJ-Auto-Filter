...
class evamaria(Client):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            api_id=28758972,
            api_hash=4e75eb6c300c41d2003671f2b21641e7,
...
API_ID = int(environ['28758972'])
API_HASH = environ['4e75eb6c300c41d2003671f2b21641e7']
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DBMANGO:DBMANGO@cluster0.fvanimj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "VJAutoFilter")
...
S_GROUP = environ.get('S_GROUP',"https://t.me/VJ_Bot_Disscussion")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/vj_bots")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+Uj9gpoQplndkMGU1")
